public class Bai7 {
    // Gợi ý: Khai báo các thuộc tính với các phạm vi truy cập khác nhau
    public String publicAttribute = "Public";
    private String privateAttribute = "Private";
    protected String protectedAttribute = "Protected";
    String defaultAttribute = "Default"; // Không có phạm vi truy cập (mặc định)
    ...
    public static void main(String[] args) {
        ...
        // Kiểm tra truy cập từ lớp ngoài
